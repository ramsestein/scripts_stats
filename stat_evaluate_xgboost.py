...
MODEL_FILE = 'xgb_model_severe.joblib'                # trained XGBoost model file
THRESHOLD = 0.5                                # probability threshold for classification

# Output files
PREDICTIONS_FILE = 'xgb_predictions_severe.xlsx'
METRICS_FILE = 'xgb_metrics_severe.xlsx'
