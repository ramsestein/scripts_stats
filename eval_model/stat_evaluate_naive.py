...
from sklearn.metrics import (
    ...
    cohen_kappa_score, balanced_accuracy_score, log_loss, brier_score_loss,
...
MODEL_FILE = 'naive_bayes_model.joblib'  # Trained Naive Bayes model file
# Threshold for class assignment from probability
THRESHOLD = 0.5

# Output files
PREDICTIONS_FILE = 'naive_bayes_predictions.xlsx'
METRICS_FILE = 'naive_bayes_metrics.xlsx'
...
def main():
    ...
    print(f"Loaded Gaussian Naive Bayes model from '{MODEL_FILE}'")
    ...
    for idx, row in df.iterrows():
        # Skip rows with missing or infinite values
