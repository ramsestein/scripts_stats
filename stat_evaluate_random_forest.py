...
MODEL_FILE = 'rf_model_severe.joblib'        # Trained Random Forest model file
# Threshold for class assignment from probability
THRESHOLD = 0.5

# Output files
PREDICTIONS_FILE = 'rf_predictions_severe.xlsx'
METRICS_FILE = 'rf_metrics_severe.xlsx'
...
def main():
    ...
    print(f"Random Forest model loaded from '{MODEL_FILE}'")
