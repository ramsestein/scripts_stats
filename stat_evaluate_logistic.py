...
EXCEL_FILE = 'iprove_gen_30.xlsx'             # dataset path
MODEL_FILE = 'logistic_model.joblib'           # trained logistic regression model file
THRESHOLD = 0.5                                # probability threshold for classification

# Output files
PREDICTIONS_FILE = 'logistic_predictions.xlsx'
METRICS_FILE = 'logistic_metrics.xlsx'
...
def main():
    ...
    print(f"Loaded Logistic Regression model from '{MODEL_FILE}'")
    ...
    for idx, row in df.iterrows():
        # Skip rows with missing or infinite
